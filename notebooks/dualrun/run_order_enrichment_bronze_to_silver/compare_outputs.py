...
COMPARE_PAIRS = [{'left_ref': '`databricks-migrate-activity`.schema1.silver_orders_dual_clone_1', 'right_ref': '`databricks-migrate-activity`.schema1.silver_orders_dual_clone_2', 'label': 'silver_orders'}]
