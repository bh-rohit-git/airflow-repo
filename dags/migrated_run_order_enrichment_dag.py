...
_DAG_SIZING_PATH = Path(__file__).resolve().parent.parent / 'plugins' / 'migrated_run_order_enrichment_bronze_to_silver_cluster_config.yml'
...
if not _DAG_SIZING_PATH.is_file():
    raise FileNotFoundError('migrated_run_order_enrichment_bronze_to_silver_cluster_config.yml not found under plugins/. Upload it to gs://<composer_bucket>/plugins/migrated_run_order_enrichment_bronze_to_silver_cluster_config.yml.')
