...
with DAG(
    dag_id="dualrun_OrderEnrichmentMain_e62f2e72b6e7",
    ...
    trigger_source_dag = TriggerDagRunOperator(
        ...
        trigger_dag_id="dualrun_child_unmigrated_OrderEnrichmentMain_e62f2e72b6e7",
    ...
    trigger_migrated_dag = TriggerDagRunOperator(
        ...
        trigger_dag_id="dualrun_child_migrated_OrderEnrichmentMain_e62f2e72b6e7",
