...
with DAG(
    dag_id="dualrun_Main_50ae8a8b63fb",
    ...
    trigger_source_dag = TriggerDagRunOperator(
        ...
        trigger_dag_id="dualrun_child_unmigrated_Main_50ae8a8b63fb",
    ...
    trigger_migrated_dag = TriggerDagRunOperator(
        ...
        trigger_dag_id="dualrun_child_migrated_Main_50ae8a8b63fb",
