...
with DAG(
    dag_id="dualrun_RawOrderIngestionMain_e47eed664a83",
    ...
    trigger_source_dag = TriggerDagRunOperator(
        ...
        trigger_dag_id="dualrun_child_unmigrated_RawOrderIngestionMain_e47eed664a83",
    ...
    trigger_migrated_dag = TriggerDagRunOperator(
        ...
        trigger_dag_id="dualrun_child_migrated_RawOrderIngestionMain_e47eed664a83",
