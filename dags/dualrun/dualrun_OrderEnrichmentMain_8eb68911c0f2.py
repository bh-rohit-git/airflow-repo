...
with DAG(
    dag_id="dualrun_OrderEnrichmentMain_8eb68911c0f2",
    ...
    trigger_source_dag = TriggerDagRunOperator(
        ...
        trigger_dag_id="dualrun_child_unmigrated_OrderEnrichmentMain_8eb68911c0f2",
    ...
    trigger_migrated_dag = TriggerDagRunOperator(
        ...
        trigger_dag_id="dualrun_child_migrated_OrderEnrichmentMain_8eb68911c0f2",
