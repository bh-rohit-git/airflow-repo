...
with DAG(
    dag_id="dualrun_Main_e4fb0a971fe9",
    ...
    trigger_source_dag = TriggerDagRunOperator(
        ...
        trigger_dag_id="dualrun_child_unmigrated_Main_e4fb0a971fe9",
    ...
    trigger_migrated_dag = TriggerDagRunOperator(
        ...
        trigger_dag_id="dualrun_child_migrated_Main_e4fb0a971fe9",
