...
with DAG(
    dag_id="dualrun_OrderEnrichmentMain_329cfa88231b",
    ...
    trigger_source_dag = TriggerDagRunOperator(
        ...
        trigger_dag_id="dualrun_child_unmigrated_OrderEnrichmentMain_329cfa88231b",
    ...
    trigger_migrated_dag = TriggerDagRunOperator(
        ...
        trigger_dag_id="dualrun_child_migrated_OrderEnrichmentMain_329cfa88231b",
