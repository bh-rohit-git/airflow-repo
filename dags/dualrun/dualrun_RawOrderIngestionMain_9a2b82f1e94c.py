...
DAG_PARAMS = {
    ...
    "idle-timeout": Param(default="5 minutes", type="string"),
...
with DAG(
    dag_id="dualrun_RawOrderIngestionMain_9a2b82f1e94c",
    ...
    trigger_source_dag = TriggerDagRunOperator(
        ...
        trigger_dag_id="dualrun_child_unmigrated_RawOrderIngestionMain_9a2b82f1e94c",
    ...
    trigger_migrated_dag = TriggerDagRunOperator(
        ...
        trigger_dag_id="dualrun_child_migrated_RawOrderIngestionMain_9a2b82f1e94c",
