...
with DAG(
    dag_id="dualrun_RawOrderIngestionMain_b5a2e1e4f32b",
    ...
    trigger_source_dag = TriggerDagRunOperator(
        ...
        trigger_dag_id="dualrun_child_unmigrated_RawOrderIngestionMain_b5a2e1e4f32b",
    ...
    trigger_migrated_dag = TriggerDagRunOperator(
        ...
        trigger_dag_id="dualrun_child_migrated_RawOrderIngestionMain_b5a2e1e4f32b",
