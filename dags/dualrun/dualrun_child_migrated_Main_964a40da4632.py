...
_DAG_SIZING_PATH = Path(__file__).resolve().parent.parent / 'plugins' / 'test_spark_merge_serverless_dag_cluster_config.yml'
...
if not _DAG_SIZING_PATH.is_file():
    raise FileNotFoundError('test_spark_merge_serverless_dag_cluster_config.yml not found under plugins/. Upload it to gs://<composer_bucket>/plugins/test_spark_merge_serverless_dag_cluster_config.yml.')
