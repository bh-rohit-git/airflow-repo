...
with DAG(
    dag_id="dualrun_OrderEnrichmentMain_2963b5afb119",
    ...
    trigger_source_dag = TriggerDagRunOperator(
        ...
        trigger_dag_id="dualrun_child_unmigrated_OrderEnrichmentMain_2963b5afb119",
    ...
    trigger_migrated_dag = TriggerDagRunOperator(
        ...
        trigger_dag_id="dualrun_child_migrated_OrderEnrichmentMain_2963b5afb119",
