...
SOURCE_DAG_CONF = {
    "dual_run": {
        ...
        "project_id": "f688c817-6660-4b01-81f7-2f1ca81a8937",
        "target_overrides": {
...
with DAG(
    ...
    ensure_dualrun_clones = DatabricksSubmitRunOperator(
        ...
        json=_serverless_notebook_task("ensure_clones", f"{DATABRICKS_WORKSPACE_BASE}/test_spark_merge_serverless_dag/ensure_clones.py", {}),
    )
