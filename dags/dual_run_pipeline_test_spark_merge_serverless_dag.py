...
with DAG(
    ...
    ensure_dualrun_clones = DatabricksSubmitRunOperator(
        ...
        json=_serverless_notebook_task("ensure_clones", "dbfs:/Volumes/databricks-migrate-activity/schema1/dualrun/test_spark_merge_serverless_dag/ensure_clones.py", {}),
    )
