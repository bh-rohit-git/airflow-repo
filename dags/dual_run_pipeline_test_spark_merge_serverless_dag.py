...
SOURCE_DAG_CONF = {
    "dual_run": {
        ...
        "project_id": "3c1d4a5d-9a8a-47d6-87d4-063a70ab8a48",
        "target_overrides": {
...
with DAG(
    ...
    compare_dualrun_outputs = DatabricksSubmitRunOperator(
        ...
        json=_serverless_notebook_task(
            ...
            {'dual_run_id': "{{ (dag_run.conf or {}).get('dual_run_id', dag_run.run_id) }}", 'project_name': "{{ (dag_run.conf or {}).get('project_name', dag.dag_id) }}", 'report_root': '/Volumes/databricks-migrate-activity/schema1/dualrun/dual_run_reports'},
        ),
    )
